...
![](https://github.com/Nizeyumukiza/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/Nizeyumukiza/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/Nizeyumukiza/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/Nizeyumukiza/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/Nizeyumukiza/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/Nizeyumukiza/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7m57.744s                 | 59.658s                   | 
| `pg_normalized_batch`  |                           |                           | 
| `pg_denormalized`      | 18.468s                   | 4.061s                    | 
